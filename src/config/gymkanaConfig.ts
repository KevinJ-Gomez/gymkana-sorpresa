...
export const gymkanaConfig: DayConfig[] = [
  ...
  },
  {
    ...
    dailyPlan: {
      ...
      photoLayout: "grid",
      photos: [
        "/images/plans/entrada_alcazar.jpg",
        "/images/plans/reserva_arabesca.jpg",
        "/images/plans/entrada_catedral_giralda.jpg",
        "/images/plans/reserva_voltereta.jpg",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    hintExtra: "Pista: escríbele por WhatsApp a Marta y pregúntale por \"la clave del día 6\".",
  ...
  },
  {
    ...
    rewardTitle: "¡Tu regalo adelantado! 👜",
    rewardDescription:
      "Hoy no hay sorpresa nueva porque este regalazo ya te lo dimos por adelantado. ¡Aquí tienes la prueba del delito! 😂❤️",
    imageSrc: "/images/spoiler-original.jpg",
    imageCaption: "Elegido con mucho amor por tu familia política y tu novio.",
  },
  {
    id: 9,
    ...
    rewardTitle: "¡Mensaje descifrado!",
    rewardDescription: "Has descifrado el audio secreto con la ayuda de Dani.",
  },
  {
    id: 10,
