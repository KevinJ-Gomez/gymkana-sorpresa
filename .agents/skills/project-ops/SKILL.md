...
1. Read `AGENTS.md` and inspect the current implementation before acting.
...
8. User instructions override general skill guidance unless they conflict with mandatory repository or safety constraints.
